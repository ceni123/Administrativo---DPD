...
const DIVISOES = {
  ...
  mary: {
    ...
    brasao: "",
    patentes: [
      { titulo: "Supervisor MARY", aliases: ["Supervisor MARY 🚁", "Supervisor MARY"] },
      { titulo: "Manager MARY", aliases: ["Manager MARY 🚁", "Manager MARY"] },
      { titulo: "Sub-Manager", aliases: ["(MARY) Sub-Manager 🚁", "(MARY) Sub-Manager"] },
      { titulo: "Conselheiro", aliases: ["(MARY) Conselheiro 🚁", "(MARY) Conselheiro", "(MARY) Conselheiro"] },
      { titulo: "Braço Direito", aliases: ["(MARY) Braço Direito 🚁", "(MARY) Braço Direito"] },
      { titulo: "Piloto Elite", aliases: ["(MARY) Piloto Elite 🚁", "(MARY) Piloto Elite"] },
      { titulo: "Piloto Veterano", aliases: ["(MARY) Piloto Veterano 🚁", "(MARY) Piloto Veterano"] },
      { titulo: "Piloto Oficial", aliases: ["(MARY) Piloto Oficial 🚁", "(MARY) Piloto Oficial"] },
      { titulo: "Piloto Probatório", aliases: ["(MARY) Piloto Probatório 🚁", "(MARY) Piloto Probatório"] },
    ],
  },
